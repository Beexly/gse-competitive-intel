...
TARGETS = ["adanos.org","adj.news","aixbet.ai","alerts.chat","alphascope.app","artemisanalytics.com",
"astron.markets","aura.money","bankr.bot","baozi.bet","based.one","bbb.community",
"berryinvesting.com","betmoar.fun","betstack.app","billybets.ai","blockworks.com","brosonpm.trade",
"clickhouse.com","clutch.market","compose.build","converge.market","cookie.fun","datalayer.xyz",
"deepnewz.com","defillama.com","dexu.ai","dimes.fi","domeapi.io","dune.com"]
...
for dom in TARGETS:
    ...
    dossier = {
        ...
        "discovery_metadata": {"method": "scripted http fetch + delegated crawl, composed from raw evidence",
